                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" name="phone" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="profile" class="form-control  @error('profile') is-invalid @enderror" type="file" accept="image/*" value="{{ old('profile') }}" name="profile">
