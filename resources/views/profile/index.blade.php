    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateProfile',Auth::user()) }}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ Auth::user()->name }}" required autocomplete="off" autofocus>
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ Auth::user()->phone }}" autocomplete="off">
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <input type="radio" name="gender" value="Male" @if(Auth::user()->gender=="Male") checked @endif>Male
                                    <br>
                                    <input type="radio" name="gender" value="Female" @if(Auth::user()->gender=="Female") checked @endif>Female
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <textarea id="address" class="form-control  @error('address') is-invalid @enderror" name="address">{{ Auth::user()->address }}</textarea>
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <input id="profile" class="form-control  @error('profile') is-invalid @enderror" type="file" accept="image/*" name="profile" value="{{ Auth::user()->profile }}">
                                @endif
